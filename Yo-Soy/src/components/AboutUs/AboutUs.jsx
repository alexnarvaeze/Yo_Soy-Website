        ...
        <div className="about-columns">
          <div className="about-left">
            ...
            <p className="bio-2">
              ...
              success in the United States. Bettsy's personal experience fuels
              our mission to assist others navigating the intricate path of
          ...
          <div className="about-right">
            <p className="bio-3">
              ...
              pursuing citizenship, applying for visas, or seeking residency,
            ...
            <p className="bio-5">
              ...
              realizing your American dream. Contact us today and let us help
              you navigate the complexities of immigration with confidence and
              ease.
            </p>
          </div>
        </div>
